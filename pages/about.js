          ...
          <div className={styles.container}>
            ...
            <div className={styles.cardGridWide}>
              <div className={styles.card}> 
                <h3 className={styles.cardTitle}>Current tech stacks</h3>
                <p className={styles.cardText}>Projects use modern stacks so you learn tools that teams already run in production.</p>
              </div>
              <div className={styles.card}> 
                <h3 className={styles.cardTitle}>Evidence over claims</h3>
                <p className={styles.cardText}>You collect commits, demos, and write-ups — artifacts recruiters can review quickly.</p>
              </div>
              <div className={styles.card}> 
                <h3 className={styles.cardTitle}>Career-safe support</h3>
                <p className={styles.cardText}>Mentors highlight gaps early and help you close them before interviews.</p>
              </div>
              <div className={styles.card}> 
                <h3 className={styles.cardTitle}>Soft skills built-in</h3>
                <p className={styles.cardText}>Practice updates, async comms, and concise documentation — the signals teams notice.</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className={styles.container}>
            ...
            <div className={styles.trustGrid}>
              <div className={styles.trustItem}>
                <h3 className={styles.trustTitle}>Proof of work</h3>
                <p className={styles.cardText}>Versioned code, demo links, and changelogs to discuss in interviews.</p>
              </div>
              <div className={styles.trustItem}>
                <h3 className={styles.trustTitle}>Documented learnings</h3>
                <p className={styles.cardText}>Concise summaries of what you built, why it matters, and what you would improve.</p>
              </div>
              <div className={styles.trustItem}>
                <h3 className={styles.trustTitle}>Mentor validation</h3>
                <p className={styles.cardText}>Feedback that highlights strengths and gaps to share with recruiters.</p>
              </div>
            </div>
          </div>
        </section>
